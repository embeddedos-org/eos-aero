...
Applies to every task in `eos-aero`.
...
No build manifest was detected at the repository root. Inspect the subdirectories before assuming any build or test command.
